package com.food.ordring.system.kafka.consumer.config;

import com.food.ordring.system.kafka.config.data.KafkaConfigData;
import com.food.ordring.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG,
                kafkaConsumerConfigData.getMaxPartitionsFetchBytesDefault() *
                        kafkaConsumerConfigData.getMaxPartitionsFetchBytesBoostFactor());
